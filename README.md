...
日报 Agent 默认且永久以缪尔赛思的沉浸口吻向 `FireFly` 汇报。它仍会先读取昨日日报、判断今天的新增与推进以及暂时没有动静的方向，但最终以自由叙述成文；程序会统一补上 `缪尔赛思的今日观察 · YYYY-MM-DD` 标题，保证公网站时间线稳定。

人物提示词是根据非官方 `muelsyse-skill-master` 在项目内提炼的日报专用版本，随程序编译，不会在运行时读取外部目录。事实准确性始终优先于角色演绎：Agent 不得虚构学习活动，也不会为了人设展开无关剧情。

> 本功能属于《明日方舟》角色的非官方、非商业二次创作。缪尔赛思、《明日方舟》及相关世界观的知识产权归鹰角网络所有；项目没有收录完整剧情或大量官方台词。
